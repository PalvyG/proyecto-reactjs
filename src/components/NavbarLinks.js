                    ...
                    <button type="button" className="btn btn-danger border-radius-none">
                        {
                            mediaQueryTablet.matches
                                ?
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-cpu" viewBox="0 0 16 16">
                    ...
                    <button type="button" className="btn btn-danger border-radius-right">
                        {
                            mediaQueryTablet.matches
                                ?
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-fan" viewBox="0 0 16 16">
